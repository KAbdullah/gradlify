...
public class ProfGradeController {
    ...
    /**
     * Endpoint to download the latest grading result CSV file.
     *
     * The file is generated by ProfGradeService and stored temporarily on disk.
     *
     * @return CSV file containing grading results, or 404 if file doesn't exist
     */
    @GetMapping("/results/download")
    public ResponseEntity<Resource> downloadResults() {
        String path = ProfGradeService.getGradingResultsPath();
        String downloadedFileName = ProfGradeService.getGradingFileName();
